export const Gala = () => {
    return (
        <div>
            {/* header */}
            <div className="w-full flex p-14 justify-center items-center">
                <div className="w-3/4 md:w-5/8">
                    <h2 className="text-[#08457E] font-bold text-xl sm:text-2xl md:text-4xl mb-4">Light of Light Gala</h2>
                    <p className="w-7/8 text-l">Our upcoming annual charity event will focus on advocating for child survival around the world and will feature keynote speaker Sediqa Sarwari, founder of Young Leaders Initiative World. 
                        We’ll also have food, a photo booth, and tons of chances to win raffle prizes!</p>
                    <div className="flex gap-2 my-4">
                        <div className="bg-[#08457E] text-sm sm:text-md md:text-lg w-2/5 sm:w-2/7 md:w-2/7 lg:w-1/5 text-[#EBFAFF] rounded-xl p-2 text-center">
                            SFU Burnaby
                        </div>
                        <div className="bg-[#EBFAFF] text-sm sm:text-md md:text-lg w-3/5 sm:w-3/7 md:w-3/7 lg:w-1/3 text-[#08457E] rounded-xl p-2 text-center">
            ...
            <div className="bg-[#EBFAFF] w-full flex flex-col p-15 lg:p-20 justify-center items-center gap-5 sm:gap-8">
                <h2 className="text-[#08457E] text-xl sm:text-2xl lg:text-4xl font-bold">Early Bird Tickets Available Now!</h2>
            ...
            <div className="w-full flex flex-col p-15 justify-center items-center gap-6 mb-7">
                <h2 className="text-[#08457E] font-bold text-2xl md:text-3xl">Our Keynote Speaker</h2>
